...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=KItFVLjZ#34809mmnF54ju5P0M26XUujmhV0dngB8z7hCRBAxVK4' : process.env.SESSION_ID,
...
WORK_TYPE: process.env.WORK_TYPE || 'pubic' ,
